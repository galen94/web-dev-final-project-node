...
export default class CommuterController implements CommuterControllerI {
    ...
    public static getInstance = (app: Express): CommuterController => {
        if(CommuterController.commuterController === null) {
            ...
            // app.get("/api/users/username/:username/delete", CommuterController.commuterController.deleteUsersByUsername);
        }
    ...
    //     CommuterController.commuterDao.deleteUsersByUsername(req.params.username).then(status => res.send(status));
    // }
}
